...
MatrixOne is now available in version v26.3.0.10. We've done a lot of optimization work on stability, and it's ready to be used in the production business.
